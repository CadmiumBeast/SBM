...
export default function EditTier({ tier }: EditPageProps) {
    ...
    <AppLayout>
      <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6 bg-slate-50 dark:bg-slate-900/80">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-50">Edit Tier</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Update tier information</p>
          </div>
